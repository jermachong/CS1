...
exefile = "program3"
txtsolfile = "/samplesolutionp3.txt"
studentsoltxtfile = "/program3solution_student_output.txt"
cfile = "program3_lastname_firstname.c"
...
def result():
    ...
    if len(l1) == len(l2) and functools.reduce(lambda x, y : x and y, map(lambda p, q: p == q, l1, l2), True):   
        ...
        print(" \      / ")
        print("  ------  ")
        print("Oh no! Your output was incorrect. Did you draw your Linked List on Paper like Dr. Steinberg said to do?") 
...
def setupchecker():
    ...
    if not os.path.exists(cwd + txtsolfile):
        ...
        " Please place the samplesolutionp3 text file in this directory and try again. Script Exiting!")
