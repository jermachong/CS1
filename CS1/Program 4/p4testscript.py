...
exefile = "program4"
txtsolfile = "/samplesolutionp4.txt"
studentsoltxtfile = "/program4solution_student_output.txt"
cfile = "program4_lastname_firstname.c"
...
def result():
    ...
    if len(l1) == len(l2) and functools.reduce(lambda x, y : x and y, map(lambda p, q: p == q, l1, l2), True):   
        ...
        print(" \      / ")
        print("  ------  ")
        print("Oh no! Your output was incorrect. Did you draw your on Paper like Dr. Steinberg said to do?") 
...
def setupchecker():
    ...
    if not os.path.exists(cwd + txtsolfile):
        ...
        " Please place the samplesolutionp4 text file in this directory and try again. Script Exiting!")
